    ...
    metadata: [
      {
        name: "keywords",
        content:
          "undocumented APIs, Microsoft portal APIs, Defender XDR API, Intune API, Windows Autopatch API, Microsoft 365 admin API, M365 Apps API, Purview API, Entra API, OpenAPI, Postman",
      },
      {
        property: "og:type",
        content: "website",
